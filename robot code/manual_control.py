...
def manualdrive(inputarray, control_state, speeds):
    while True:
        ...
        if control_state.value == State.remote:
            ...
            turning_vector = ml.combine_moves (movement_vector, ml.rotate_omni(5*(inputarray[0]-inputarray[2]), [10,10,0])) # calculate turning vector
            wheel_speeds = ml.rectify_speed(turning_vector, 60) #set movement speed
