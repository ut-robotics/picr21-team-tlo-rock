...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(GPIOA, TIM3_CH2_ENCB_Pin|TIM3_CH1_ENCA_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, TIM4_CH1_ENCA_Pin|TIM4_CH2_ENCB_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB8-BOOT0     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(TIM8_CH1_ENCA_GPIO_Port, TIM8_CH1_ENCA_Pin);

    HAL_GPIO_DeInit(TIM8_CH2_ENCB_GPIO_Port, TIM8_CH2_ENCB_Pin);
